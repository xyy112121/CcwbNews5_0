...
-(void)gotovercode
{
    ...
    [RequestInterface doGetJsonWithParametersForUser:params App:app ReqUrl:InterfaceUserForgetPwdVerifyCode ShowView:app.window alwaysdo:^{
...
-(void)clickregiestdone
{
    ...
    [RequestInterface doGetJsonWithParametersForUser:params App:app ReqUrl:InterfaceUserModifyPwd ShowView:app.window alwaysdo:^{
