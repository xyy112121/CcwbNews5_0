...
+ (NSString *)jumpToBizPay:(NSDictionary *)dicorder {

	DLog(@"dicorder===%@",dicorder);
	...
	req.partnerId           = [dicorder objectForKey:@"partnerid"];
	req.prepayId            = [dicorder objectForKey:@"prepayid"];
	req.nonceStr            = [dicorder objectForKey:@"noncestr"];
	req.timeStamp           = [[dicorder objectForKey:@"timestamp"] intValue];
	req.package             = [dicorder objectForKey:@"package"];
	req.sign                = [dicorder objectForKey:@"sign"];
	[WXApi sendReq:req];
