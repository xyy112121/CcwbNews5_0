...
+(void)doGetJsonWithParametersNoAn:(NSDictionary * )parameters App:(AppDelegate *)app ReqUrl:(NSString *)requrl ShowView:(UIView *)showview alwaysdo:(void(^)(void))always Success:(void (^)(NSDictionary * dic))success  Failur:(void (^)(NSString * strmsg))failure;
